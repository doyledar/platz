			...
			<section class="work">
				...
				<figure class="white">
					...
					<div id="wrapper-part-info">
						<div class="part-info-image"><img src="{{ asset('assets/img/icon-psd.svg') }}" alt="" width="28" height="28"/></div>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/font-1.jpg') }}" alt="" />
						<dl>
							<dt>Free font</dt>
					...
					<div id="wrapper-part-info">
						<div class="part-info-image"><img src="{{ asset('assets/img/icon-font.svg') }}" alt="" width="28" height="28"/></div>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/psd-1.jpg') }}" alt="" />
						<dl>
							<dt>PSD Goodies</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/psd-2.jpg') }}" alt="" />
						<dl>
							<dt>PSD Goodies</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/ai-1.jpg') }}" alt="" />
						<dl>
					...
					<div id="wrapper-part-info">
						<div class="part-info-image"><img src="{{ asset('assets/img/icon-ai.svg') }}" alt="" width="28" height="28"/></div>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/theme-2.jpg') }}" alt="" />
						<dl>
							<dt>Html theme</dt>
							<dd>Symphony is a responsive one page website template designed with sketches and coded with html5 and php. Freebie released by Lacoste Xavier.</dd>
						</dl>
					...
					<div id="wrapper-part-info">
						<div class="part-info-image"><img src="{{ asset('assets/img/icon-themes.svg') }}" alt="" width="28" height="28"/></div>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/psd-3.jpg') }}" alt="" />
						<dl>
							<dt>PSD goodies</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/font-2.jpg') }}" alt="" />
						<dl>
							<dt>Free font</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/font-3.jpg') }}" alt="" />
						<dl>
							<dt>Wordpress theme</dt>
							<dd>Symphony is a responsive one page website template designed with sketches and coded with html5 and php. Freebie released by Lacoste Xavier.</dd>
						</dl>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/ai-2.jpg') }}" alt="" />
						<dl>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/icons-1.jpg') }}" alt="" />
						<dl>
							<dt>PSD icons</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/ui-1.jpg') }}" alt="" />
						<dl>
							<dt>UI design</dt>
					...
					<div id="wrapper-part-info">
						<div class="part-info-image"><img src="{{ asset('assets/img/icon-premium.svg') }}" alt="" width="28" height="28"/></div>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/font-5.jpg') }}" alt="" />
						<dl>
							<dt>Free font</dt>
							<dd>A set of 6 outline beer icons created with Adobe Illustrator. Free Ai designed and released by Justas Galaburda.</dd>
						</dl>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/psd-5.jpg') }}" alt="" />
						<dl>
							<dt>PSD mockup</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/icons-3.jpg') }}" alt="" />
						<dl>
							<dt>PSD icons</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/font-4.jpg') }}" alt="" />
						<dl>
							<dt>Free font</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/theme-3.jpg') }}" alt="" />
						<dl>
							<dt>HTML theme</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/font-6.jpg') }}" alt="" />
						<dl>
							<dt>Free font</dt>
				...
				<figure class="white">
					<a href="#">
						<img src="{{ asset('assets/img/theme-4.jpg') }}" alt="" />
						<dl>
							<dt>HTML theme</dt>
