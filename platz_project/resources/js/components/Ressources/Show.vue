...
<div class="container object">
  ...
  <div id="main-container-image">
    ...
    <div class="work">
      <figure class="white">
           <img :src="`assets/img/${ressource.image}`" alt="" />
      </figure>
            ...
            <div class="wrapper-text-description">
              ...
              <div class="wrapper-file">
                  <div class="icon-file"><img :src="`assets/img/${categorie(ressource).icone}`" alt="" width="21" height="21"/></div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ressource() {
        // Récupération de la variable d'URL d'une route du router (ici l'id de la ressource sélectionnée)
